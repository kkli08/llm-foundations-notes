...
- 设计 Accepted Length、Tokens/Target Forward、TPOT、Tokens/s、P90/P99 和显存占用的对照实验；
...
- [vLLM MTP](https://github.com/vllm-project/vllm/blob/main/docs/features/speculative_decoding/mtp.md)：架构特定 MTP 支持及共享 KV Cache 的实现例外。
